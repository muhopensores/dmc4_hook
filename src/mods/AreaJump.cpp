...
std::optional<std::string> AreaJump::on_initialize() {
    ...
    utility::create_keyboard_hotkey(m_hotkeys, { VK_LCONTROL, VK_OEM_4 }, "Restart BP stage", "bp_restart_stage_hotkey");
    utility::create_keyboard_hotkey(m_hotkeys, { VK_LCONTROL, VK_OEM_6 }, "Next BP stage", "bp_next_stage_hotkey");
