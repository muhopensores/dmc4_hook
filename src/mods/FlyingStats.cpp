...
static void DisplayCollisionData(uCollisionMgr* currentEnemyCollision, float currentItemWidth) {
    ...
    case 0:
        ...
        ImGui::InputScalar(_("base.mp_next_unit"), ImGuiDataType_U64, &currentEnemyCollision->base.mp_next_unit, NULL, NULL, "%08X", ImGuiInputTextFlags_ReadOnly);
        ImGui::InputScalar(_("base.mp_prev_unit"), ImGuiDataType_U64, &currentEnemyCollision->base.mp_prev_unit, NULL, NULL, "%08X", ImGuiInputTextFlags_ReadOnly);
    ...
    if (SMediator* sMedPtr = devil4_sdk::get_sMediator()) {
        ...
        if (showFlyingPlayerStats) {
            ...
            if (w2s::IsVisibleOnScreen(objectPosition)) {
                ...
                // if (showFlyingDT) ImGui::InputFloat("DT Timer##EnemyFly", &player->DTTimer, NULL, NULL, "%.0f"); // id * 4 + DevilMayCry4_DX9.exe+9EC0E0
