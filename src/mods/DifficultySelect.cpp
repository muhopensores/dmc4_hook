...
void DifficultySelect::set_default() {
    install_patch_absolute(0x44d6c7,  patch1, "\x87\x78\xC7", 3);
    install_patch_absolute(0x494ae7,  patch2, "\x14", 1);
    install_patch_absolute(0x494b02,  patch3, "\x28\xAD", 2);
    install_patch_absolute(0x4b5689, patch4, "\x24\xF3\xC0\x00", 4);
    install_patch_absolute(0x51b9b6, patch5, "\x74", 1);
    install_patch_absolute(0x51b9be, patch6, "\x14\x74\x05\xBA\x02", 5);
    install_patch_absolute(0x51b9db, patch7, "\xFC\xBE", 2);
    install_patch_absolute(0x51b9e4, patch8, "\xE8\xBE", 2);
    install_patch_absolute(0x51ba85, patch9, "\xC4\xBF", 2);
    install_patch_absolute(0x51ba90, patch10, "\xB0\xBF", 2);
    install_patch_absolute(0x51bafa, patch11, "\x74", 1);
    install_patch_absolute(0x51bb02, patch12, "\x14\x74\x05\xB9\x02", 5);
    install_patch_absolute(0x51bb19, patch13, "\x24\xBF", 2);
    install_patch_absolute(0x51bb21, patch14, "\x10\xBF", 2);
    install_patch_absolute(0x5d2197, patch15, "\xD0\x28", 2);
    install_patch_absolute(0x634d4c, patch16, "\x03\x75", 2);
    install_patch_absolute(0x634d5b, patch17, "\x44", 1);
    install_patch_absolute(0x64d6f6, patch18, "\x24\x5B", 2);
    install_patch_absolute(0x64d80d, patch19, "\x03\x75", 2);
    install_patch_absolute(0x64d81c, patch20, "\x44", 1);
    install_patch_absolute(0x654383, patch21, "\x24\x5b", 2);
    install_patch_absolute(0x6892ab, patch22, "\x03\x75", 2);
    install_patch_absolute(0x6892ba, patch23, "\x44", 1);
    install_patch_absolute(0x6949a4, patch24, "\x02", 1);
    install_patch_absolute(0x6abb41, patch25, "\x03\x75", 2);
    install_patch_absolute(0x6abb50, patch26, "\x44", 1);
    install_patch_absolute(0x6c0435, patch27, "\x40\x01\x00\x00\x75", 5);
    install_patch_absolute(0x6c0445, patch28, "\x14", 1);
    install_patch_absolute(0x6da9ca, patch29, "\x5C\xA0", 2);
    install_patch_absolute(0x6da9eb, patch30, "\x03\x75", 2);
    install_patch_absolute(0x6fad4e, patch31, "\x40\x01\x00\x00\x75", 5);
    install_patch_absolute(0x6fad60, patch32, "\x44", 1);
    install_patch_absolute(0x704e9e, patch33, "\x40\x01\x00\x00\x75", 5);
    install_patch_absolute(0x704eb0, patch34, "\x44", 1);
    install_patch_absolute(0x7309a0, patch35, "\x03\x74", 2);
    install_patch_absolute(0x743b6a, patch36, "\x24\xF3\xC0\x00", 4);
    install_patch_absolute(0x7bfd41, patch37, "\xA8\x27\xD6", 3);
    install_patch_absolute(0x7bfd72, patch38, "\xF0\xF2", 2);
    install_patch_absolute(0x7c0309, patch39, "\x88\x9F", 2);
    install_patch_absolute(0x778d60, patch40, "\x01", 1);
    install_patch_absolute(0x7a7b09, patch41, "\x40", 1);
    install_patch_absolute(0x8ab93c, patch42, "\x24\xF3\xC0\x00", 4);
    install_patch_absolute(0xc37a5f, patch43, "\x20\x1C", 2);
    install_patch_absolute(0xdec0e0, patch44,
        ...
        "\x00\x00\xe1\x44\x00\x00\x80\xBF\x00\x00\x61\x45\x00\xc0\x28\x45\x00\xc0\x28\x45", 72);
    install_patch_absolute(0xdec8b4, patch45, "\x00\x00\xe1\x45", 4);
    install_patch_absolute(0xdec9f4, patch46, "\x00\x00\xe1\x45", 4);
    install_patch_absolute(0xdecb34, patch47, "\x00\x00\xe1\x45", 4);
    install_patch_absolute(0xdecc74, patch48, "\x00\x00\xe1\x45", 4);
    install_patch_absolute(0xdecdb4, patch49, "\x00\x00\xe1\x45", 4);
}

void DifficultySelect::set_dmd() {
    install_patch_absolute(0x44d6c7, patch1, "\x05\xA8\xCD", 3);
    install_patch_absolute(0x494ae7, patch2, "\x00", 1);
    install_patch_absolute(0x494b02, patch3, "\x50\xB9", 2);
    install_patch_absolute(0x4b5689, patch4, "\x70\x01\xCC\x00", 4);
    install_patch_absolute(0x51b9b6, patch5, "\x72", 1);
    install_patch_absolute(0x51b9be, patch6, "\x00\x74\x05\xBA\x00", 5);
    install_patch_absolute(0x51b9db, patch7, "\xF4\xBE", 2);
    install_patch_absolute(0x51b9e4, patch8, "\xF4\xBE", 2);
    install_patch_absolute(0x51ba85, patch9, "\xC4\xBF", 2);
    install_patch_absolute(0x51ba90, patch10, "\xB0\xBF", 2);
    install_patch_absolute(0x51bafa, patch11, "\x72", 1);
    install_patch_absolute(0x51bb02, patch12, "\x00\x74\x05\xB9\x00", 5);
    install_patch_absolute(0x51bb19, patch13, "\x40\xBD", 2);
    install_patch_absolute(0x51bb21, patch14, "\x40\xBD", 2);
    install_patch_absolute(0x5d2197, patch15, "\xD0\x28", 2);
    install_patch_absolute(0x634d4c, patch16, "\x05\x74", 2);
    install_patch_absolute(0x634d5b, patch17, "\x44", 1);
    install_patch_absolute(0x64d6f6, patch18, "\x24\x5B", 2);
    install_patch_absolute(0x64d80d, patch19, "\x05\x74", 2);
    install_patch_absolute(0x64d81c, patch20, "\x44", 1);
    install_patch_absolute(0x654383, patch21, "\x24\x5b", 2);
    install_patch_absolute(0x6892ab, patch22, "\x05\x74", 2);
    install_patch_absolute(0x6892ba, patch23, "\x44", 1);
    install_patch_absolute(0x6949a4, patch24, "\x02", 1);
    install_patch_absolute(0x6abb41, patch25, "\x05\x74", 2);
    install_patch_absolute(0x6abb50, patch26, "\x44", 1);
    install_patch_absolute(0x6c0435, patch27, "\x44\x01\x00\x00\x77", 5);
    install_patch_absolute(0x6c0445, patch28, "\x14", 1);
    install_patch_absolute(0x6da9ca, patch29, "\x5C\xA0", 2);
    install_patch_absolute(0x6da9eb, patch30, "\x05\x74", 2);
    install_patch_absolute(0x6fad4e, patch31, "\x44\x01\x00\x00\x77", 5);
    install_patch_absolute(0x6fad60, patch32, "\x44", 1);
    install_patch_absolute(0x704e9e, patch33, "\x44\x01\x00\x00\x77", 5);
    install_patch_absolute(0x704eb0, patch34, "\x44", 1);
    install_patch_absolute(0x7309a0, patch35, "\x05\x75", 2);
    install_patch_absolute(0x743b6a, patch36, "\x70\x01\xCC\x00", 4);
    install_patch_absolute(0x7bfd41, patch37, "\xA8\x27\xD6", 3);
    install_patch_absolute(0x7bfd72, patch38, "\xF0\xF2", 2);
    install_patch_absolute(0x7c0309, patch39, "\x88\x9F", 2);
    install_patch_absolute(0x778d60, patch40, "\x01", 1);
    install_patch_absolute(0x7a7b09, patch41, "\x40", 1);
    install_patch_absolute(0x8ab93c, patch42, "\x70\x01\xCC\x00", 4);
    install_patch_absolute(0xc37a5f, patch43, "\x30\x2A", 2);
    install_patch_absolute(0xdec0e0, patch44,
        "\x00\xc0\x28\x45\x00\xc0\x28\x45\x00\x00\x80\xbf\x00\xc0\xa8\x45\x00\x00\x80\xBF\x00\x00\x61\x45\x00\x00"
        "\xe1\x45\x00\x00\x80\xBF\x00\xc0\x28\x45\x00\xa0\x0c\x46\x00\xa0\x8c\x45\x00\x00\x61\x45\x00\xa0\x0c\x46"
        "\x00\x00\xe1\x44\x00\x00\x80\xBF\x00\x00\x61\x45\x00\xc0\x28\x45\x00\xc0\x28\x45", 72);
    install_patch_absolute(0xdec8b4, patch45, "\x00\xC0\x28\x46", 4);
    install_patch_absolute(0xdec9f4, patch46, "\x00\xC0\x28\x46", 4);
    install_patch_absolute(0xdecb34, patch47, "\x00\xC0\x28\x46", 4);
    install_patch_absolute(0xdecc74, patch48, "\x00\xC0\x28\x46", 4);
    install_patch_absolute(0xdecdb4, patch49, "\x00\xC0\x28\x46", 4);
}
...
void DifficultySelect::set_gmd() {
    ...
    install_patch_absolute(0x494ae7, patch2, "\x00", 1);
    install_patch_absolute(0x494b02, patch3, "\x50\xB9", 2);
    install_patch_absolute(0x4b5689, patch4, "\xC4\xCD\xDE\x00", 4);
    install_patch_absolute(0x51b9b6, patch5, "\x72", 1);
    install_patch_absolute(0x51b9be, patch6, "\x00\x74\x05\xBA\x00", 5);
    install_patch_absolute(0x51b9db, patch7, "\x10\xBF", 2);
    install_patch_absolute(0x51b9e4, patch8, "\x10\xBF", 2);
    install_patch_absolute(0x51ba85, patch9, "\x04\xC0", 2);
    install_patch_absolute(0x51ba90, patch10, "\x04\xC0", 2);
    install_patch_absolute(0x51bafa, patch11, "\x72", 1);
    install_patch_absolute(0x51bb02, patch12, "\x00\x74\x05\xB9\x00", 5);
    install_patch_absolute(0x51bb19, patch13, "\x48\xBD", 2);
    install_patch_absolute(0x51bb21, patch14, "\x48\xBD", 2);
    install_patch_absolute(0x5d2197, patch15, "\x14\x2E", 2);
    install_patch_absolute(0x634d4c, patch16, "\x05\x74", 2);
    install_patch_absolute(0x634d5b, patch17, "\x48", 1);
    install_patch_absolute(0x64d6f6, patch18, "\xA4\x3E", 2);
    install_patch_absolute(0x64d80d, patch19, "\x05\x74", 2);
    install_patch_absolute(0x64d81c, patch20, "\x48", 1);
    install_patch_absolute(0x654383, patch21, "\xA4\x3E", 2);
    install_patch_absolute(0x6892ab, patch22, "\x05\x74", 2);
    install_patch_absolute(0x6892ba, patch23, "\x48", 1);
    install_patch_absolute(0x6949a4, patch24, "\x01", 1);
    install_patch_absolute(0x6abb41, patch25, "\x05\x74", 2);
    install_patch_absolute(0x6abb50, patch26, "\x48", 1);
    install_patch_absolute(0x6c0435, patch27, "\x44\x01\x00\x00\x77", 5);
    install_patch_absolute(0x6c0445, patch28, "\x5A", 1);
    install_patch_absolute(0x6da9ca, patch29, "\xA8\x9E", 2);
    install_patch_absolute(0x6da9eb, patch30, "\x05\x74", 2);
    install_patch_absolute(0x6fad4e, patch31, "\x44\x01\x00\x00\x77", 5);
    install_patch_absolute(0x6fad60, patch32, "\x48", 1);
    install_patch_absolute(0x704e9e, patch33, "\x44\x01\x00\x00\x77", 5);
    install_patch_absolute(0x704eb0, patch34, "\x48", 1);
    install_patch_absolute(0x7309a0, patch35, "\x05\x75", 2);
    install_patch_absolute(0x743b6a, patch36, "\xC4\xCD\xDE\x00", 4);
    install_patch_absolute(0x7bfd41, patch37, "\xF0\xF2\xC0", 3);
    install_patch_absolute(0x7bfd72, patch38, "\xFC\xEE", 2);
    install_patch_absolute(0x7c0309, patch39, "\xFF\x87", 2);
    install_patch_absolute(0x778d60, patch40, "\x00", 1);
    install_patch_absolute(0x7a7b09, patch41, "\x3C", 1);
    install_patch_absolute(0x8ab93c, patch42, "\xC4\xCD\xDE\x00", 4);
    install_patch_absolute(0xc37a5f, patch43, "\x50\x46", 2);
    install_patch_absolute(0xdec0e0, patch44,
        ...
        "\x00\x00\x61\x44\x00\x00\x80\xBF\x00\x00\xE1\x44\x00\xC0\xA8\x44\x00\xC0\xA8\x44", 72);
    install_patch_absolute(0xdec8b4, patch45, "\x00\xA0\x8C\x46", 4);
    install_patch_absolute(0xdec9f4, patch46, "\x00\xA0\x8C\x46", 4);
    install_patch_absolute(0xdecb34, patch47, "\x00\xA0\x8C\x46", 4);
    install_patch_absolute(0xdecc74, patch48, "\x00\xA0\x8C\x46", 4);
    install_patch_absolute(0xdecdb4, patch49, "\x00\xA0\x8C\x46", 4);
    //reset_patches();
    /*
