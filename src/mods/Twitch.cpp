    ...
    if (display == DISPLAY_SYSTEM_A) {
        ...
        if (ImGui::CollapsingHeader(_("Twitch Integration"))) {
            ...
            if (!libirc_loaded) {
                ...
                gui::ImGuiURL libircclient_url{"https://sourceforge.net/projects/libircclient/files/libircclient/1.10/",
                    "https://sourceforge.net/projects/libircclient/files/libircclient/1.10/"};
