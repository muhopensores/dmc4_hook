...
void PlayerTracker::on_gui_frame(int display) {
    if (ImGui::CollapsingHeader(_("Display Player Stats"))) {
        ...
        if (player) {
            ...
            ImGui::InputScalar(_("Move ID ##1"), ImGuiDataType_U8, &player->moveIDBest, NULL, NULL, "%02X", ImGuiInputTextFlags_CharsHexadecimal);
            ImGui::InputScalar(_("Move ID2 ##1"), ImGuiDataType_U8, &player->moveID2, NULL, NULL, "%02X", ImGuiInputTextFlags_CharsHexadecimal);
            ImGui::InputScalar(_("Move Bank ##1"), ImGuiDataType_U8, &player->moveBank, NULL, NULL, "%02X", ImGuiInputTextFlags_CharsHexadecimal);
            ImGui::InputScalar(_("Move Part ##1"), ImGuiDataType_U8, &player->movePart, NULL, NULL, "%02X", ImGuiInputTextFlags_CharsHexadecimal);
