...
public:
    ...
    std::string get_mod_name() override { return "AerialDrive"; };
    ...
    std::unique_ptr<FunctionHook> hook1, hook2, hook3, hook4, hook5, hook6, hook7, hook8, hook9;
};