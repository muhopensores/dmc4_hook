...
void SetDefault()
{
    ...
    {
        difficultySelectFortyNine_patch.apply(
            difficultySelectFortyNine,
            ...
            "\x00\x00\xe1\x44\x00\x00\x78\x30\x00\x00\x61\x45\x00\xc0\x28\x45\x00\xc0\x28\x45",
            72);
    }
}
...
void SetGMD()
{
    ...
    if (difficultySelectFortyNine)
    {
        difficultySelectFortyNine_patch.apply(
            ...
            "\x00\x00\x61\x44\x00\x00\x78\x30\x00\x00\xe1\x44\x00\xc0\xa8\x44\x00\xc0\xa8\x44",
            72);
    }
}
...
void ToggleDisableDarkslayerLeft(bool toggle)
{
