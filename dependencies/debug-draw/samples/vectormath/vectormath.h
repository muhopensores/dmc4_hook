...
inline float * toFloatPtr(Vectormath::Aos::Vector3 & v) { return reinterpret_cast<float *>(&v); }
inline float * toFloatPtr(Vectormath::Aos::Vector4 & v) { return reinterpret_cast<float *>(&v); }
...
inline const float * toFloatPtr(const Vectormath::Aos::Vector3 & v) { return reinterpret_cast<const float *>(&v); }
inline const float * toFloatPtr(const Vectormath::Aos::Vector4 & v) { return reinterpret_cast<const float *>(&v); }
...
inline Point3 toPoint3(const Vectormath::Aos::Vector4 & v4)
{
